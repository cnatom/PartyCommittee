...
class _RuxiaoPageState extends State<RuxiaoPage> {
  ...
  TextEditingController peitongController =
  new TextEditingController(); //陪同人员
  Map questions = {
    'q1' : true,
    'q2' : true,
    'q3' : true,
  ...
  TextEditingController benrenController =
  new TextEditingController(); //本人签名
  TextEditingController jianhuController =
  new TextEditingController(); //监护人签名
  ...
  //水平选择布局（抵徐地点）
  String dixuCurValue;
  Widget _dixuChose(String title, List infoList, ) {
    return Container(
      margin: EdgeInsets.fromLTRB(10, 0, 10, 0),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.start,
...
//长条式卡片按钮(有内容)
  ...
  //增加/删除中转 按钮
  Widget MyLittleButton(String title,{GestureTapCallback onTap,Color color = Colors.redAccent}){
    return Material(
      borderRadius: BorderRadius.circular(30),
      color: color,
      child:InkWell(
        ...
        child: Container(
          ...
          child: Text(title,style: TextStyle(fontSize: 15,color: Colors.white,letterSpacing: 2,fontWeight: FontWeight.bold)),
        ),
      ),
    );
  }
  ...
  void _passInfoGet()async{
    ...
    try{
      ...
      //配置dio信息
      res = await dio.get(
        "http://49.233.32.252:9090/api/backSchools/passInfo",
...
//        chuxing.data['dixu'] == null ||//抵徐地点
  ...
  void _delpassInfo()async{
    ...
    try{
      ...
      res = await dio.delete(
          "http://49.233.32.252:9090/api/backSchools",
          options: Options(headers: {"Authorization":token})
      );
      debugPrint(res.toString());
      //Json解码为Map
  ...
  //重新提交信息
  //长篇文章
  Widget _article(String text,{Color color = Colors.black,FontWeight fontWeight = FontWeight.normal}) {
    return Padding(
...
//            MyTitleStep('第一步：完善基本信息'),
          _columnCard(children: [
            ...
            Padding(
              ...
              child: MyInputBarFlex(juzhuController,
                  hintText: "请填写街道/小区/村、门牌号等"),
            ),
                  ...
                  child: Wrap(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Text("路线 - ${index}",style: TextStyle(fontSize: 18,color: Colors.black38),),
                      ),
                      _rowInputItem('起始站点', qishiController[index], hintText: "如：潍坊站"),
                      _rowInputItem('目标站点', mubiaoController[index]),
                      _chuxingChose('出行方式', index),
                      _rowInputItem('车牌号/车次', chepaiController[index],hintText: "如：Z168"),
                      _rowInputItem('座位号', zuoweiController[index],hintText: "如：5车14座或无(自驾)"),
                    ],
                  ),
                );
              }).toList(),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  Expanded(
                    flex: 2,
                    child: MyLittleButton('+增加中转行程',color: mainColor.withAlpha(230),onTap: ()=>_addTransitItem()),
                  ),
                  SizedBox(width: 10,),
                  Expanded(
          ...
          _columnCard(children: [
            ...
            _article('输入姓名将用于生成电子签名，表明您已阅读并承诺以上内容',color: Colors.red,fontWeight: FontWeight.bold),
            ...
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  SizedBox(width: 20,),
                  Text("等待管理员审核......",style: TextStyle(fontSize: 17),)
  ...
  Widget build(BuildContext context) {
    return _position==null?loadingPage():Scaffold(
      key: _scaffoldKey,
